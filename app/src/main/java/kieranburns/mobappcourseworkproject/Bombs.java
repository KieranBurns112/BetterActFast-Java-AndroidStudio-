...
public class Bombs {
    ...
    public Bombs(Context context) {
        ...
        //bombX = (GameWindow.displayX /2) - (currentBomb[0].getWidth() /2);
    ...
    private void BlackBomb (Context context){
        currentBomb[0] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[1] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[2] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[3] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[4] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[5] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[6] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[7] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_4);
        currentBomb[8] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[9] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[10] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[11] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[12] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[13] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[14] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[15] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_3);
        currentBomb[16] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[17] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[18] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[19] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[20] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[21] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[22] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[23] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_2);
        currentBomb[24] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[25] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[26] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[27] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[28] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[29] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[30] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[31] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb_1);
        currentBomb[32] = BitmapFactory.decodeResource(context.getResources(),R.drawable.black_bomb);
    }
